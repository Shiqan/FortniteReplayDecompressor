...
//{
//    public class FortniteBinaryDecompressor
//    {
...
//        public FortniteBinaryDecompressor()
//        {
//        }

//        public FortniteBinaryDecompressor(Stream input, Replay replay)
//        {
//            this.Replay = replay;
//        }

//        public FortniteBinaryDecompressor(Stream input, int offset)
//        {
...
//                if (Replay..EngineNetworkVersion < EngineNetworkVersionHistory.HISTORY_NETEXPORT_SERIALIZATION)
//                {
...
//                    {
//                        Debug($"packets/checkpoint-packet-{packetIndex}-{replayDataIndex}-{startPos}", packet.Data);
