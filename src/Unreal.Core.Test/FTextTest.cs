...
namespace Unreal.Core.Test
{
    ...
    {
        [Fact]
        public void PlayerNameCustomOverrideTest()
        {
            byte[] rawData = {
                ...
                0x4F, 0x72, 0x64, 0x65, 0x72, 0x00
            };

            var reader = new NetBitReader(rawData, 528);
        ...
        [Fact]
        public void StreamerModeNameTest()
        {
            byte[] rawData = {
                ...
                0x4C, 0x65, 0x61, 0x64, 0x65, 0x72, 0x00
            };

            var reader = new NetBitReader(rawData, 536);
            var playerName = new FText();
            playerName.Serialize(reader);
        ...
        [Fact]
        public void StreamerModeNameTest2()
        {
            byte[] rawData = {
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x21, 0x00, 0x00,
            ...
            var reader = new NetBitReader(rawData, 600);
            var playerName = new FText();
            playerName.Serialize(reader);
