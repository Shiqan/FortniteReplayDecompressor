    ...
    public class FGameplayTagContainerTest
    {
        ...
        public void PoiContainerTest()
        {
            byte[] rawData = {
                ...
                0x0C, 0x2E, 0x30, 0x02, 0xC1, 0x24, 0x00, 0x0E, 0x2E
            };

            var reader = new NetBitReader(rawData, 360);
        ...
        [Fact]
        public void GoldenPoiTagsTest()
        {
            byte[] rawData = {
                0x04, 0x7F, 0x32, 0x8B, 0x32
            };

            var reader = new NetBitReader(rawData, 40);
            var points = new FGameplayTagContainer();
            points.Serialize(reader);
