...
namespace FortniteReplayReaderDecompressor.Core.Models
{
    ...
    /// </summary>
    public class CheckpointInfo : IVisitable<CheckpointInfo>
    {
        ...
        public CheckpointInfo Accept(ReplayVisitor visitor, FArchive archive)
        {
            return visitor.ReadCheckpoint(archive);
        }
    }
}
