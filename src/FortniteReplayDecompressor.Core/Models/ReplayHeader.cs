...
namespace FortniteReplayReaderDecompressor.Core.Models
{
    ...
    /// </summary>
    public class ReplayHeader : IVisitable<ReplayHeader>
    {
        ...
        public ReplayHeader Accept(ReplayVisitor visitor, FArchive archive)
        {
            return visitor.ReadReplayHeader(archive);
        }
    }
}
